...
function ContactForm() {
  ...
  return (
    <div className='contact-form d-flex fd-column al-center'>
      <h2> {appContext.languages[appContext.language].contact.tile} </h2>
      <form onSubmit={handleSubmit}>
        ...
        <div className='d-flex form-group al-center jc-end'>
         {formSubmitted && <p className='text-primary'>{appContext.languages[appContext.language].sucessMsg}</p>}
